...
if __name__ == "__main__":
    ...
    pkl_path = '/mainfs/scratch/dk2g21/AutoNovel/data/cifar10/noisy_labels/archive/data.pkl'

    # Load noisy labels from data.pkl
    if os.path.exists(pkl_path):
        with open(pkl_path, 'rb') as f:
            noisy_labels = pickle.load(f)
        # Select the desired noise type
        selected_noise_type = 'worse_label'  # Default to None if key not found
        if selected_noise_type in noisy_labels:
            selected_labels = noisy_labels[selected_noise_type]
            print(f"Using noisy labels: {selected_noise_type}")
        else:
            selected_labels = None
            print(f"Warning: {selected_noise_type} not found in data.pkl. Using clean labels.")
    else:
        selected_labels = None

    if args.dataset_name == 'cifar10':
        if selected_labels is not None:
            mix_train_loader = CIFAR10LoaderMix(
                ...
                noisy_labels=selected_labels
            )
    
            labeled_train_loader = CIFAR10Loader(
                root=args.dataset_root,
                batch_size=args.batch_size,
                split='train',
                aug='once',
            ...
            labeled_eval_loader = CIFAR10Loader(
            root=args.dataset_root,
            batch_size=args.batch_size,
            split='test',
            aug=None,
            ...
            unlabeled_eval_loader_test = CIFAR10Loader(
                root=args.dataset_root,
                batch_size=args.batch_size,
                split='test',
                aug=None,
            ...
            all_eval_loader = CIFAR10Loader(
                root=args.dataset_root,
                batch_size=args.batch_size,
                split='test',
                aug=None,
                shuffle=False,
                target_list=range(num_classes)
            )
        ...
        labeled_train_loader = CIFAR100Loader(
            root=args.dataset_root,
            batch_size=args.batch_size,
            split='train',
            aug='once',
        ...
        unlabeled_eval_loader = CIFAR100Loader(
            root=args.dataset_root,
            batch_size=args.batch_size,
            split='train',
            aug=None,
        ...
        unlabeled_eval_loader_test = CIFAR100Loader(
            root=args.dataset_root,
            batch_size=args.batch_size,
            split='test',
            aug=None,
        ...
        labeled_eval_loader = CIFAR100Loader(
            root=args.dataset_root,
            batch_size=args.batch_size,
            split='test',
            aug=None,
        ...
        all_eval_loader = CIFAR100Loader(
            root=args.dataset_root,
            batch_size=args.batch_size,
            split='test',
            aug=None,
        ...
        mix_train_loader = SVHNLoaderMix(
            root=args.dataset_root,
            batch_size=args.batch_size,
            split='train',
            aug='twice',
        ...
        labeled_train_loader = SVHNLoader(
            root=args.dataset_root,
            batch_size=args.batch_size,
            split='train',
            aug='once',
        ...
        unlabeled_eval_loader = SVHNLoader(
            root=args.dataset_root,
            batch_size=args.batch_size,
            split='train',
            aug=None,
        ...
        unlabeled_eval_loader_test = SVHNLoader(
            root=args.dataset_root,
            batch_size=args.batch_size,
            split='test',
            aug=None,
        ...
        labeled_eval_loader = SVHNLoader(
            root=args.dataset_root,
            batch_size=args.batch_size,
            split='test',
            aug=None,
